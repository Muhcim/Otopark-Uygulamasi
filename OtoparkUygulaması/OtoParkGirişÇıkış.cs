...
{
    public partial class OtoParkGirişÇıkış : Form
    {
        public OtoParkGirişÇıkış()
        {
            InitializeComponent();
        }
         DateTime deger;
        ...
        void griddoldur()
    {
        ...
        private void OtoParkGirişÇıkış_Load(object sender, EventArgs e)
        {
            griddoldur();
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            cmd.Connection = con;
            cmd.CommandText = "insert into otomasyon (adi_soyadi,plaka,telno,giris_saati,cikis_saati) values ('" + adtxt.Text + "','" + TxtPlaka.Text + "','" + maskedTextBox1.Text + "','" + bsaat.Text + "','" + textBox2.Text + "')";
            cmd.ExecuteNonQuery();
            con.Close();
            griddoldur();
        }
